...
public class BoardUtils {
    ...
    public static int getCoordinateAtPosition(final String position) {
        System.out.println("!!! inside getCoordinatedAtPosition of BoardUtils.java   and returning after returning coordinate****");
        return POSITION_TO_COORDINATE.get(position);
    }
    
    public static String getPositionAtCoordinate(final int coordinate) {
        System.out.println("!!! inside getPositionAtCoordinate of BoardUtils.java   and returning after returning position****");
