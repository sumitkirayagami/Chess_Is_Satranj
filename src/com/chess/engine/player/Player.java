...
public abstract class Player {
    ...
    //TODO implement thse methods below!!!!
    public boolean isInCheck() {
        return this.isInCheck;
    }
    
    public boolean isInCheckMate () {
        boolean ans = this.isInCheck && !hasEscapeMoves();
        if(ans){
            try{
            GameOver gameOver = new GameOver(this.getOpponent().getAlliance().toString(),1);
            }catch(Exception e){}
        }
        return ans;
    }
    ...
    public boolean isInStaleMate() {
        ...
        if(ans){
            try{
            GameOver gameOver = new GameOver("Game Drawn",0);
            }catch(Exception e){}
        }
        return ans;
    }
    ...
    public MoveTransition makeMove(final Move move) {
        ...
        System.out.println("inside Player.java file");
